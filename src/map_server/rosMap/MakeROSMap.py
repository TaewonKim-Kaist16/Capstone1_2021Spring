...
#
file_name = input("What is the name of your floor plan you want to convert to a ROS map:" )
print(file_name)
...
#
        if x1[0] == 0:
           ...
           x1[1]=ix
           y1[1]=iy
           deltax = float(input("What is the x distance in meters between the 2 points?" ))
           ...
           deltay = float(input("What is the y distance in meters between the 2 points?" ))
           x1[3]=ix
           y1[3]=iy    
	   ...
	   #  Open a file
           mapName = input("What is the name of the new map?" )
