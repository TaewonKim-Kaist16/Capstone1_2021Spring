...
if("TRUE" STREQUAL "TRUE")
  set(core_msgs_SOURCE_PREFIX /home/jhkim/catkin_ws/Capstone1_2021Spring/src/core_msgs)
  set(core_msgs_DEVEL_PREFIX /home/jhkim/catkin_ws/Capstone1_2021Spring/devel)
  ...
  set(core_msgs_INSTALL_PREFIX /home/jhkim/catkin_ws/Capstone1_2021Spring/install)
...
if(NOT "/home/jhkim/catkin_ws/Capstone1_2021Spring/devel/include " STREQUAL " ")
  set(core_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/jhkim/catkin_ws/Capstone1_2021Spring/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'core_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jhkim/catkin_ws/Capstone1_2021Spring/src/core_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT core_msgs_NUM_DUMMY_TARGETS)
      set(core_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::core_msgs::wrapped-linker-option${core_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR core_msgs_NUM_DUMMY_TARGETS "${core_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::core_msgs::wrapped-linker-option${core_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND core_msgs_LIBRARIES "${interface_target_name}")
